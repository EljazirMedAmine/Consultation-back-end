...
class UpdateAssuranceRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'delete_documents.array' => 'La liste des documents à supprimer doit être un tableau.',
            'delete_documents.*.exists' => 'Un document sélectionné pour suppression n\'existe pas.',
        ];
    }
}
